...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --with debug
%{?_with_debug:%global _with_debug --enable-debug}

# if you wish to compile an rpm with cmocka unit testing...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --with cmocka
%{?_with_cmocka:%global _with_cmocka --enable-cmocka}

# if you wish to compile an rpm without rdma support, compile like this...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without rdma
...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without epoll
%{?_without_epoll:%global _without_epoll --disable-epoll}

# if you wish to compile an rpm without fusermount...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without fusermount
%{?_without_fusermount:%global _without_fusermount --disable-fusermount}

# if you wish to compile an rpm without geo-replication support, compile like this...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without georeplication
...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without ocf
%{?_without_ocf:%global _without_ocf --without-ocf}

# if you wish to build rpms without syslog logging, compile like this
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without syslog
...
# rpmbuild -ta glusterfs-3.10.0.tar.gz --without bd
...
%else
Source0:          glusterfs-3.10.0.tar.gz
%endif
...
* Fri Jan 20 2017 Kaleb S. KEITHLEY <kkeithle@redhat.com>
- python2 (versus python3) cleanup (#1415226)
